...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以使用 <code>SHOW INDEX FROM 表名</code>，来查看索引，如下：<img src="https://gitlab.com/apzs/apzs/-/raw/master/CommonFunctions/image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA6I2J6I6T5pGH5pGH5aW25piULQ==,size_20,color_FFFFFF,t_70,g_se,x_16.png" alt="" loading="lazy"></p><figure><img src="https://gitlab.com/apzs/apzs/-/raw/master/CommonFunctions/image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA6I2J6I6T5pGH5pGH5aW25piULQ==,size_20,color_FFFFFF,t_70,g_se,x_16-167092054531470.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p><strong>显示创建：</strong></p><ul><li>创建普通索引</li></ul><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>#创建普通索引
CREATE TABLE book(
book_id INT,
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gitlab.com/apzs/apzs/-/raw/master/CommonFunctions/image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA6I2J6I6T5pGH5pGH5aW25piULQ==,size_20,color_FFFFFF,t_70,g_se,x_16-167092054531471.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ul><li>创建唯一索引</li></ul><p>声明有唯一索引的字段，在添加数据时，要保证唯一性，但是可以添加NULL值。</p><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>#创建唯一索引
CREATE TABLE book1(
book_id INT,
book_name VARCHAR(100),
\`authors\` VARCHAR(100),
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gitlab.com/apzs/apzs/-/raw/master/CommonFunctions/image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA6I2J6I6T5pGH5pGH5aW25piULQ==,size_20,color_FFFFFF,t_70,g_se,x_16-167092054531573.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ul><li>创建全文索引</li></ul><p>值得说明的是，全文索引比LIKE + %的方式快N倍！但要注意版本支不支持！此外，如果需要全文索引的是大量数据，建议先添加数据，后创建索引。</p><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>#创建全文索引
CREATE TABLE book3(
book_id INT,
book_name VARCHAR(100),
\`authors\` VARCHAR(100),
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gitlab.com/apzs/apzs/-/raw/master/CommonFunctions/image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA6I2J6I6T5pGH5pGH5aW25piULQ==,size_20,color_FFFFFF,t_70,g_se,x_16-167092054531574.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p><strong>在表已经创建之后再添加索引</strong></p><ul><li>通过 ALTER TABLE 表名 ADD 索引 这种方式来添加索引</li></ul><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>CREATE TABLE book4(
book_id INT,
book_name VARCHAR(100),
\`authors\` VARCHAR(100),
info VARCHAR(100),
...
--       ) time
  ...
  GROUP BY
    time
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>按分钟汇总查询结果展示</p><figure><img src="https://gitlab.com/apzs/apzs/-/raw/master/CommonFunctions/image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2dyeTcyOTkyNDMxNQ==,size_16,color_FFFFFF,t_70.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p><strong>举例2（日期字段为Date类型）</strong></p><ul><li><pre><code>Date类型的汇总完整SQL
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,21);function L(C,N){const e=d("ExternalLinkIcon");return t(),r("div",null,[m,n("h2",o,[u,s(" 2.1、"),n("a",p,[s("添加索引"),a(e)])]),n("p",null,[v,s("：使用CREATE TABLE创建表时，在声明有"),n("a",b,[s("主键约束"),a(e)]),s("、唯一性约束、外键约束的字段上，会自动的添加相关的索引。")]),_,n("h2",g,[h,s(" 2.2、"),n("a",k,[s("每隔m行选择n个"),a(e)])]),y,n("h2",R,[F,s(" 2.3、"),n("a",A,[s("MySQL每隔N分钟汇总"),a(e)])]),f,n("h2",q,[T,s(" 2.4、"),n("a",E,[s("查看容量"),a(e)])]),x])}const H=l(c,[["render",L],["__file","2.mysql.html.vue"]]);export{H as default};
