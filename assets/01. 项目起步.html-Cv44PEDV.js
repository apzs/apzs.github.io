import{_ as p}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as o,o as i,c,a as n,b as s,d as e,e as t}from"./app-AMUHiwF7.js";const l={},u=t(`<h1 id="小兔鲜儿-项目起步" tabindex="-1"><a class="header-anchor" href="#小兔鲜儿-项目起步" aria-hidden="true">#</a> 小兔鲜儿 - 项目起步</h1><h2 id="项目架构" tabindex="-1"><a class="header-anchor" href="#项目架构" aria-hidden="true">#</a> 项目架构</h2><h3 id="项目架构图" tabindex="-1"><a class="header-anchor" href="#项目架构图" aria-hidden="true">#</a> 项目架构图</h3><figure><img src="https://gitlab.com/apzs/apzs/-/raw/master/front-project/小兔鲜儿uni-app (Vue3+ts)/image/index_picture_1.png" alt="项目架构图" tabindex="0" loading="lazy"><figcaption>项目架构图</figcaption></figure><h2 id="拉取项目模板代码" tabindex="-1"><a class="header-anchor" href="#拉取项目模板代码" aria-hidden="true">#</a> 拉取项目模板代码</h2><p>项目模板包含：目录结构，项目素材，代码风格。</p><h3 id="模板地址" tabindex="-1"><a class="header-anchor" href="#模板地址" aria-hidden="true">#</a> 模板地址</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> clone http://git.itcast.cn/heimaqianduan/erabbit-uni-app-vue3-ts.git heima-shop
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote><p>注意事项</p><ul><li>在 <code>manifest.json</code> 中添加微信小程序的 <code>appid</code>（注意是<code>mp-weixin</code>下的appid，不是开头的appid）</li></ul></blockquote><h2 id="引入-uni-ui-组件库" tabindex="-1"><a class="header-anchor" href="#引入-uni-ui-组件库" aria-hidden="true">#</a> 引入 uni-ui 组件库</h2><h3 id="操作步骤" tabindex="-1"><a class="header-anchor" href="#操作步骤" aria-hidden="true">#</a> 操作步骤</h3>`,11),r={href:"https://uniapp.dcloud.net.cn/component/uniui/quickstart.html#npm%E5%AE%89%E8%A3%85",target:"_blank",rel:"noopener noreferrer"},d=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">pnpm</span> i @dcloudio/uni-ui
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="小程序端-pinia-持久化" tabindex="-1"><a class="header-anchor" href="#小程序端-pinia-持久化" aria-hidden="true">#</a> 小程序端 Pinia 持久化</h2><p>说明：项目中 Pinia 用法平时完全一致，主要解决持久化插件<strong>兼容性</strong>问题。</p><h3 id="持久化存储插件" tabindex="-1"><a class="header-anchor" href="#持久化存储插件" aria-hidden="true">#</a> 持久化存储插件</h3>`,10),k={href:"https://prazdevs.github.io/pinia-plugin-persistedstate/guide/config.html#storage",target:"_blank",rel:"noopener noreferrer"},v=t(`<p>插件默认使用 <code>localStorage</code> 实现持久化，小程序端不兼容，需要替换持久化 API。</p><p><strong>网页端持久化 API</strong></p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">// 网页端API</span>
...
`),n("span",{class:"token keyword"},"export"),s(),n("span",{class:"token keyword"},"const"),s(" useMemberStore "),n("span",{class:"token operator"},"="),s(),n("span",{class:"token function"},"defineStore"),n("span",{class:"token punctuation"},"("),s(`
  ...
  `),n("span",{class:"token punctuation"},"{"),s(`
    ...
    persist`),n("span",{class:"token operator"},":"),s(),n("span",{class:"token punctuation"},"{"),s(`
      `),n("span",{class:"token comment"},"// 调整为兼容多端的API"),s(`
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>到此，你已完成 <code>husky</code> + <code>lint-staged</code> 的配置。</p>`,33);function q(w,j){const a=o("ExternalLinkIcon");return i(),c("div",null,[u,n("p",null,[s("安装 "),n("a",r,[s("uni-ui 组件库"),e(a)])]),d,n("p",null,[s("持久化存储插件： "),n("a",k,[s("pinia-plugin-persistedstate"),e(a)])]),v,m,b,g,n("p",null,[h,s("： "),n("a",f,[s("uni.addInterceptor"),e(a)])]),n("p",null,[y,s("："),n("a",x,[s("接口文档"),e(a)])]),_])}const P=p(l,[["render",q],["__file","01. 项目起步.html.vue"]]);export{P as default};
