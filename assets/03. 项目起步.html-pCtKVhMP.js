import{_ as t}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as p,o,c as i,a as n,b as s,d as l,e as a}from"./app-YilgCgZO.js";const c={},r=a(`<h2 id="创建项目并整理目录" tabindex="-1"><a class="header-anchor" href="#创建项目并整理目录" aria-hidden="true">#</a> 创建项目并整理目录</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> init vue@latest
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://gitlab.com/apzs/image/-/raw/master/image/1670247123883-f43f81f8-7600-4fd7-aa82-2751d9032a54.png" alt="image.png" tabindex="0" loading="lazy"><figcaption>image.png</figcaption></figure><h2 id="jsconfig-json配置别名路径" tabindex="-1"><a class="header-anchor" href="#jsconfig-json配置别名路径" aria-hidden="true">#</a> jsconfig.json配置别名路径</h2><blockquote><p>配置别名路径可以在写代码时联想提示路径</p></blockquote><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
