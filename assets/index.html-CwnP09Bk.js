...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>接下来我们查看<code>MainForm</code>是怎么被创建的。</p><p>在<code>MainForm</code>的构造方法方法开头打上断点。</p><figure><img src="https://gitlab.com/apzs/apzs/-/raw/master/cmo/image/image-20250809142043504.png" alt="image-20250809142043504" tabindex="0" loading="lazy"><figcaption>image-20250809142043504</figcaption></figure><p>然后启动项目，查看调用栈就知道了：</p><figure><img src="https://gitlab.com/apzs/apzs/-/raw/master/cmo/image/image-20250809142236524.png" alt="image-20250809142236524" tabindex="0" loading="lazy"><figcaption>image-20250809142236524</figcaption></figure><p>第一个执行的是<code>Client.MainThreadDispatcher = Dispatcher.CurrentDispatcher;</code>，其所在的方法为<span id="AdapterCallbackCandidate.RateInterruptibleMap"><code>RateInterruptibleMap</code></span>，我们再看<code>RateInterruptibleMap</code>方法是怎么被执行的。</p><figure><img src="https://gitlab.com/apzs/apzs/-/raw/master/cmo/image/image-20250809142418032.png" alt="image-20250809142418032" tabindex="0" loading="lazy"><figcaption>image-20250809142418032</figcaption></figure><p>根据搜索发现该方法绑定的是父类的<code>Startup</code>事件。</p><figure><img src="https://gitlab.com/apzs/apzs/-/raw/master/cmo/image/image-20250809142634774.png" alt="image-20250809142634774" tabindex="0" loading="lazy"><figcaption>image-20250809142634774</figcaption></figure><p>按住<code>ctrl</code>然后点击<code>Startup</code>就跳转到了<code>WindowsFormsApplicationBase</code>的<code>Startup</code>。</p><figure><img src="https://gitlab.com/apzs/apzs/-/raw/master/cmo/image/image-20250809145427569.png" alt="image-20250809145427569" tabindex="0" loading="lazy"><figcaption>image-20250809145427569</figcaption></figure><p>然后我们搜索<code>StartupEventHandler</code>，发现其在<code>OnStartup</code>方法里被使用，顺腾摸瓜就发现了其具体的逻辑：</p><p><code>Run</code>方法调用了<code>DoApplicationModel</code>方法,<code>DoApplicationModel</code>方法调用了<code>OnStartup</code>方法，<code>OnStartup</code>方法里触发了我们的事件。</p><blockquote><p><strong>编译器生成的委托字段</strong>：</p><p>当声明事件时：</p><div class="language-c# line-numbers-mode" data-ext="c#"><pre class="language-c#"><code>public event StartupEventHandler Startup;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>因此第一个调用栈的逻辑大概是<code>AdapterCallbackCandidate</code>类的<code>Main</code>方法调用<code>ItemExporter.RevertInterruptibleMap.Run(args);</code>触发了<code>Startup</code>事件。<code>AdapterCallbackCandidate</code>订阅了<code>Startup</code>事件执行<code>RateInterruptibleMap</code>方法。<code>RateInterruptibleMap</code>方法里执行了<code>Client.MainThreadDispatcher = Dispatcher.CurrentDispatcher;</code>。</p><hr><p>接下来我们看第二帧的代码。</p><p>第一帧中执行了<code>Client.MainThreadDispatcher = Dispatcher.CurrentDispatcher;</code>自然要加载<code>Client</code>类，从而执行了该类的静态代码块。代码块里创建了<code>RecorderForm</code>对象</p><div class="language-c# line-numbers-mode" data-ext="c#"><pre class="language-c#"><code>public sealed class Client
{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gitlab.com/apzs/apzs/-/raw/master/cmo/image/image-20250809161157882.png" alt="image-20250809161157882" tabindex="0" loading="lazy"><figcaption>image-20250809161157882</figcaption></figure><hr><p>接着看第七帧。此时<code>MainForm</code>的构造方法就执行了。</p><figure><img src="https://gitlab.com/apzs/apzs/-/raw/master/cmo/image/image-20250809161113010.png" alt="image-20250809161113010" tabindex="0" loading="lazy"><figcaption>image-20250809161113010</figcaption></figure><h3 id="界面代码" tabindex="-1"><a class="header-anchor" href="#界面代码" aria-hidden="true">#</a> 🐟 界面代码</h3><p>在<code>MainForm</code>的构造方法里,首先进行了一系列的初始化工作，最后调用了<code>ResetState()</code>。在<code>ResetState()</code>方法里，创建了<code>MenuStrip1主菜单</code>，在<code>MenuStrip1主菜单</code>里添加了<code>TSMI_Editor编辑</code>菜单项，在<code>TSMI_Editor编辑</code>菜单项里添加了<code>Sides_TSMI添加/编辑阵营</code>菜单项，然后将<code>MenuStrip1主菜单</code>添加到了控件中。</p><div class="language-c# line-numbers-mode" data-ext="c#"><pre class="language-c#"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="想定录制" tabindex="-1"><a class="header-anchor" href="#想定录制" aria-hidden="true">#</a> 🍑 想定录制</h2><p>Command/Command/AttackTarget.cs</p>`,132),t=[l];function a(r,v){return i(),n("div",null,t)}const o=e(s,[["render",a],["__file","index.html.vue"]]);export{o as default};
