...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gitlab.com/apzs/image/-/raw/master/image/image-20230213152048359.png" alt="image-20230213152048359" tabindex="0" loading="lazy"><figcaption>image-20230213152048359</figcaption></figure><h4 id="_1-3-3、紧凑模式-compact" tabindex="-1"><a class="header-anchor" href="#_1-3-3、紧凑模式-compact" aria-hidden="true">#</a> 1.3.3、紧凑模式（<code>compact</code>）</h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>Compilation Error
...
<span class="token selector">.container .top-left</span> <span class="token punctuation">{</span>
  ...
  <span class="token property">width</span><span class="token punctuation">:</span> 200px<span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token comment">/*# sourceMappingURL=css.css.map */</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gitlab.com/apzs/image/-/raw/master/image/image-20230213155028257.png" alt="image-20230213155028257" tabindex="0" loading="lazy"><figcaption>image-20230213155028257</figcaption></figure><h4 id="_1-4-3-属性嵌套-nested-properties" tabindex="-1"><a class="header-anchor" href="#_1-4-3-属性嵌套-nested-properties" aria-hidden="true">#</a> 1.4.3 属性嵌套 (Nested Properties)</h4><p>属性名称前都具有相同的字符时，可使用属性嵌套的方法。注：font: {}，冒号后与花括号中间需有空格进行隔开</p><p>scss文件：</p><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token selector">.container </span><span class="token punctuation">{</span>
    <span class="token selector">a </span><span class="token punctuation">{</span>
        <span class="token property">color</span><span class="token punctuation">:</span> #333<span class="token punctuation">;</span>
...
<span class="token selector">.btn-success</span> <span class="token punctuation">{</span>
  ...
  <span class="token property">color</span><span class="token punctuation">:</span> green<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gitlab.com/apzs/image/-/raw/master/image/image-20230214093051823.png" alt="image-20230214093051823" tabindex="0" loading="lazy"><figcaption>image-20230214093051823</figcaption></figure><h3 id="_1-5-代码注释" tabindex="-1"><a class="header-anchor" href="#_1-5-代码注释" aria-hidden="true">#</a> 1.5 代码注释</h3><p>支持标准的 Css 的注释语法，单行注释 <code>//</code> 与多行注释 <code>/* */</code>。注释在 .scss 中的规则：</p><ol><li>单行注释，不会解析到 <code>.css</code> 文件中；</li><li>如果选择的输出格式是<code>compressed</code>，则所有的注释信息都不会解析出来；</li><li>在多行注释中添加 “!”，则可保留这条注释到压缩文件中，此方法主要用于文件的版权声明；</li><li>多行注释中可以添加插值语句 ( <code>interpolation</code> )</li></ol><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token comment">// 单行注释</span>
