...
<span class="token string">&quot;/.vscode/**&quot;</span>
<span class="token punctuation">]</span><span class="token punctuation">,</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-3-模式" tabindex="-1"><a class="header-anchor" href="#_1-3-模式" aria-hidden="true">#</a> 1.3 模式</h2><p>修改<code>scss/css.scss</code>文件为如下所示</p><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token selector">html</span><span class="token punctuation">{</span>
    <span class="token property">font-size</span><span class="token punctuation">:</span> 12px<span class="token punctuation">;</span>
...
<span class="token selector">.container </span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-3-1、嵌套模式-nested" tabindex="-1"><a class="header-anchor" href="#_1-3-1、嵌套模式-nested" aria-hidden="true">#</a> 1.3.1、嵌套模式（<code>nested</code>）</h3><p>新版本的<code>sass-loader</code>不支持这种模式，新版本的<code>Live Sass Compiler</code>也不支持</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>Compilation Error
...
--------------------
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gitlab.com/apzs/image/-/raw/master/image/image-20230213151914201.png" alt="image-20230213151914201" tabindex="0" loading="lazy"><figcaption>image-20230213151914201</figcaption></figure><h3 id="_1-3-2、展开模式-expanded" tabindex="-1"><a class="header-anchor" href="#_1-3-2、展开模式-expanded" aria-hidden="true">#</a> 1.3.2、展开模式（<code>expanded</code>）</h3><p>展开格式就是平时我们写<code>css</code>的格式，适合开发使用</p><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token selector">html</span> <span class="token punctuation">{</span>
  <span class="token property">font-size</span><span class="token punctuation">:</span> 12px<span class="token punctuation">;</span>
  <span class="token property">color</span><span class="token punctuation">:</span> #333<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gitlab.com/apzs/image/-/raw/master/image/image-20230213152048359.png" alt="image-20230213152048359" tabindex="0" loading="lazy"><figcaption>image-20230213152048359</figcaption></figure><h3 id="_1-3-3、紧凑模式-compact" tabindex="-1"><a class="header-anchor" href="#_1-3-3、紧凑模式-compact" aria-hidden="true">#</a> 1.3.3、紧凑模式（<code>compact</code>）</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>Compilation Error
...
<span class="token selector">.container .footer</span> <span class="token punctuation">{</span>
  ...
  <span class="token property">background-color</span><span class="token punctuation">:</span> #000<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-4-2-父选择器添加内容" tabindex="-1"><a class="header-anchor" href="#_1-4-2-父选择器添加内容" aria-hidden="true">#</a> 1.4.2 父选择器添加内容 &amp;</h3><p>添加符号 ”&amp;“ ，表示在该父容器后面添加相应的后缀，可是该元素的某个行为或其他等。</p><p>当我们想对子元素设置样式时，可以写在父元素的里面，可以使用<code>&amp;</code>符号表示父元素</p><p>scss文件：</p><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token selector">.container </span><span class="token punctuation">{</span>
    <span class="token property">width</span><span class="token punctuation">:</span> 1200px<span class="token punctuation">;</span>
    <span class="token property">margin</span><span class="token punctuation">:</span> 0 auto<span class="token punctuation">;</span>
...
<span class="token selector">.container .top-left</span> <span class="token punctuation">{</span>
  ...
  <span class="token property">width</span><span class="token punctuation">:</span> 200px<span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token comment">/*# sourceMappingURL=css.css.map */</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gitlab.com/apzs/image/-/raw/master/image/image-20230213155028257.png" alt="image-20230213155028257" tabindex="0" loading="lazy"><figcaption>image-20230213155028257</figcaption></figure><h3 id="_1-4-3-属性嵌套-nested-properties" tabindex="-1"><a class="header-anchor" href="#_1-4-3-属性嵌套-nested-properties" aria-hidden="true">#</a> 1.4.3 属性嵌套 (Nested Properties)</h3><p>属性名称前都具有相同的字符时，可使用属性嵌套的方法。注：font: {}，冒号后与花括号中间需有空格进行隔开</p><p>scss文件：</p><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token selector">.container </span><span class="token punctuation">{</span>
    <span class="token selector">a </span><span class="token punctuation">{</span>
        <span class="token property">color</span><span class="token punctuation">:</span> #333<span class="token punctuation">;</span>
...
<span class="token comment">/*!
	Author: &#39;gdream@126.com&#39;.
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-6-文件导入" tabindex="-1"><a class="header-anchor" href="#_1-6-文件导入" aria-hidden="true">#</a> 1.6 文件导入</h2><p>使用 <code>@import</code> 进行文件的导入</p><h3 id="_1-6-1-原生css文件导入" tabindex="-1"><a class="header-anchor" href="#_1-6-1-原生css文件导入" aria-hidden="true">#</a> 1.6.1 原生<code>css</code>文件导入</h3><p><code>test.css</code>：</p><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token atrule"><span class="token rule">@import</span> <span class="token url"><span class="token function">url</span><span class="token punctuation">(</span>css.css<span class="token punctuation">)</span></span><span class="token punctuation">;</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_1-6-2-导入-scss-文件" tabindex="-1"><a class="header-anchor" href="#_1-6-2-导入-scss-文件" aria-hidden="true">#</a> 1.6.2 导入 .scss 文件</h3><p><code>css.scss</code>：</p><p>导入 .scss 文件的方式，使用 <code>@import</code> 进行导入，文件名可以有 .scss 后缀，也可以省略</p><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token comment">// 方法1</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-6-3-导入普通的-css-文件" tabindex="-1"><a class="header-anchor" href="#_1-6-3-导入普通的-css-文件" aria-hidden="true">#</a> 1.6.3 导入普通的 .css 文件</h3><p>以下几种方式，只会将文件作为普通的 css 语句进行引入</p><ol><li>文件拓展名为 .css</li><li>文件名以 http:// 或 https:// 开头</li><li>文件由 url() 的形式引入</li><li><template></template></li></ol><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token keyword">@import</span> <span class="token string">&#39;main.css&#39;</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-2-混合指令" tabindex="-1"><a class="header-anchor" href="#_2-2-混合指令" aria-hidden="true">#</a> 2.2 混合指令</h2><p>混合指令用于定义可重复使用的样式。混合指令可以包含所有的 Css 规则与绝大部分 Sass 规则，甚至通过参数功能引入变量，输出多样化的样式。</p><h3 id="_2-2-1-定义与使用混合指令" tabindex="-1"><a class="header-anchor" href="#_2-2-1-定义与使用混合指令" aria-hidden="true">#</a> 2.2.1 定义与使用混合指令</h3><p>使用 <code>@mixin</code> 定义混合指令以及使用 <code>@include</code> 进行调用</p><h4 id="_1-基础写法" tabindex="-1"><a class="header-anchor" href="#_1-基础写法" aria-hidden="true">#</a> 1. 基础写法</h4><p>scss文件：</p><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token comment">// 定义混合指令</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token property">background-color</span><span class="token punctuation">:</span> aqua<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-混合指令中添加选择器" tabindex="-1"><a class="header-anchor" href="#_2-混合指令中添加选择器" aria-hidden="true">#</a> 2. 混合指令中添加选择器</h4><p>scss文件：</p><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token comment">// 定义混合指令</span>
<span class="token keyword">@mixin</span> <span class="token selector">name </span><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
    ...
    <span class="token property">background-color</span><span class="token punctuation">:</span> aqua<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-带参数的混合指令" tabindex="-1"><a class="header-anchor" href="#_3-带参数的混合指令" aria-hidden="true">#</a> 3. 带参数的混合指令</h4><p>使用 <code>$name</code> 给参数命名，在调用的时候给参数赋值：</p><p>scss文件：</p><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token comment">// 定义混合指令</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-2-2-混合指令总结" tabindex="-1"><a class="header-anchor" href="#_2-2-2-混合指令总结" aria-hidden="true">#</a> 2.2.2 混合指令总结</h3><ol><li>混合指令 ( @mixin ) 是可以重复使用的一组 Css 声明；</li><li>有助于减少重复代码，只需声明一次就可以在文件中反复引用；</li><li>包含所有 Css 规则以及绝大部分 Sass 规则，甚至通过参数引入变量；</li><li>使用参数时，建议加上默认值。</li></ol><h2 id="_2-3-继承指令" tabindex="-1"><a class="header-anchor" href="#_2-3-继承指令" aria-hidden="true">#</a> 2.3 继承指令</h2><p>在不同的元素具有完全相同的样式与 Css 属性时，可以使用继承指令实现，继承指令 @extend</p><h3 id="_2-3-1-基本用法" tabindex="-1"><a class="header-anchor" href="#_2-3-1-基本用法" aria-hidden="true">#</a> 2.3.1 基本用法</h3><p>scss文件：</p><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token selector">.alert </span><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token property">color</span><span class="token punctuation">:</span> #333<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-5-变量的作用域" tabindex="-1"><a class="header-anchor" href="#_3-5-变量的作用域" aria-hidden="true">#</a> 3.5 变量的作用域</h2><h3 id="_3-5-1-局部变量" tabindex="-1"><a class="header-anchor" href="#_3-5-1-局部变量" aria-hidden="true">#</a> 3.5.1 局部变量</h3><p>在选择器中定义的变量，只能在该选择器或该选择器的子选择器中使用</p><p>scss文件：</p><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token selector">.container </span><span class="token punctuation">{</span>
    <span class="token property"><span class="token variable">$font-size</span></span><span class="token punctuation">:</span> 16px<span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-3-颜色-colors" tabindex="-1"><a class="header-anchor" href="#_4-3-颜色-colors" aria-hidden="true">#</a> 4.3 颜色 (Colors)</h2><p>Css 原有颜色类型，包括十六进制、RGB、RGBA、HSL、HSLA和色彩单词</p><h2 id="_4-4-布尔型-booleans" tabindex="-1"><a class="header-anchor" href="#_4-4-布尔型-booleans" aria-hidden="true">#</a> 4.4 布尔型 (Booleans)</h2><p>只有两个值 “true” 和 “false”，只有自身是 false 或 null 才会返回 false，其他一切都会返回 true，主要用于逻辑判断。</p><h2 id="_4-5-空值-null" tabindex="-1"><a class="header-anchor" href="#_4-5-空值-null" aria-hidden="true">#</a> 4.5 空值 (Null)</h2><p>只有一个值 “null”，如 “$name: null;”。由于他为空，因此不能使用它与任何类型进行运算，主要用于逻辑判断。</p><h2 id="_4-6-数组-lists" tabindex="-1"><a class="header-anchor" href="#_4-6-数组-lists" aria-hidden="true">#</a> 4.6 数组 (Lists)</h2><p>通过空格或半角逗号分割的一系列的值，数组中还可以包含子数组，如下方的 “$list2” 和 “$list3″，当数组被编译为 css 时，圆括号不会被添加</p><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token property"><span class="token variable">$list1</span></span><span class="token punctuation">:</span> 1px 2px 3px 4px<span class="token punctuation">;</span> <span class="token comment">//一维数字</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这是由于 CSS 不支持圆括号的写法，因此 list3 会被拆开为一组值；而 CSS 支持逗号作分隔，所以 list2 会被编译为两组值。</p><h2 id="_4-7-映射-maps" tabindex="-1"><a class="header-anchor" href="#_4-7-映射-maps" aria-hidden="true">#</a> 4.7 映射 (Maps)</h2><p>Maps 必须被圆括号包裹，可以映射任何键值对</p><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token property"><span class="token variable">$map</span></span><span class="token punctuation">:</span> <span class="token punctuation">(</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token property">color</span><span class="token punctuation">:</span> blue<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-2-关系-比较-运算符" tabindex="-1"><a class="header-anchor" href="#_5-2-关系-比较-运算符" aria-hidden="true">#</a> 5.2 关系（比较）运算符</h2><p>关系运算符只支持数字，使用的符号分别是大于号 “&gt;”，小于号 “&lt;“，大于等于号 “&gt;=” 与小于等于号 “&lt;=” ，返回值 “true” 或 “false”，主要应用于条件判断</p><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token property"><span class="token variable">$a</span></span><span class="token punctuation">:</span> 1 <span class="token operator">&gt;</span> 2<span class="token punctuation">;</span> <span class="token comment">//false</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token property">line-height</span><span class="token punctuation">:</span> 2em<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-4-数字运算符" tabindex="-1"><a class="header-anchor" href="#_5-4-数字运算符" aria-hidden="true">#</a> 5.4 数字运算符</h2><p>数字运算符包含加 <code>+</code> ，减 <code>-</code> ，乘 <code>*</code> ，除 <code>/</code> 与取模 <code>%</code> ，取模即是两个数字相除取余数。</p><h3 id="_5-4-1-基本用法" tabindex="-1"><a class="header-anchor" href="#_5-4-1-基本用法" aria-hidden="true">#</a> 5.4.1 基本用法</h3><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token comment">// 纯数字相加</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-4-2-混合用法" tabindex="-1"><a class="header-anchor" href="#_5-4-2-混合用法" aria-hidden="true">#</a> 5.4.2 混合用法</h3><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token comment">// 数字，字符串相加</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-4-4-规则总结" tabindex="-1"><a class="header-anchor" href="#_5-4-4-规则总结" aria-hidden="true">#</a> 5.4.4 规则总结</h3><ol><li>运算符号与值之间建议使用空格隔开；</li><li>数字可以只声明其中一个符号或单位，计算的结果将以声明的符号或单位进行编译，声明单位或符号时，<strong>建议在第一个数字上进行声明</strong>；</li><li>当不同符号且符号之间不可以进行换算时，无法计算出结果，如 20px + 10%无计算，”px” + “pt” 则可进行计算；</li><li>当不同单位进行运算，结果会显示以运算公式开头的数字设置的单位；</li><li>在乘法运算时，只需为一个数字声明单位，为多个数字声明同样或不同的单位都会报错；</li><li>在除法运算时，如需声明单位，单位建议标注在除号前面的值；</li><li>书写公式时，建议将所有公式都使用圆括号包裹。</li></ol><h3 id="_5-4-5-书写建议示范" tabindex="-1"><a class="header-anchor" href="#_5-4-5-书写建议示范" aria-hidden="true">#</a> 5.4.5 书写建议示范</h3><p>scss文件：</p><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token selector">.plus </span><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-5-字符串运算" tabindex="-1"><a class="header-anchor" href="#_5-5-字符串运算" aria-hidden="true">#</a> 5.5 字符串运算</h2><p>使用加号”+” 可连接字符串，如字符串前面带引号后面不带，编译出的结果会带引号，反之。</p><p>scss文件：</p><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token selector">.container </span><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-5-selector选择器函数" tabindex="-1"><a class="header-anchor" href="#_6-5-selector选择器函数" aria-hidden="true">#</a> 6.5 Selector选择器函数</h2><p>选择符相关函数可对CSS选择进行一些相应的操作， 例如: <code>selector-append()</code>可以把个选择符附加到另一个选择符， <code>selector-unify()</code>将两组选择器合成个复合选择器。</p><p>scss文件：</p><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token selector">.header </span><span class="token punctuation">{</span>
    <span class="token property">background-color</span><span class="token punctuation">:</span> #000<span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="七、流程控制指令" tabindex="-1"><a class="header-anchor" href="#七、流程控制指令" aria-hidden="true">#</a> 七、流程控制指令</h1><h2 id="_7-1-if" tabindex="-1"><a class="header-anchor" href="#_7-1-if" aria-hidden="true">#</a> 7.1 <code>@if</code></h2><p>scss文件：</p><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token property"><span class="token variable">$theme</span></span><span class="token punctuation">:</span> <span class="token string">&quot;green&quot;</span><span class="token punctuation">;</span>
<span class="token selector">.container </span><span class="token punctuation">{</span>
...
<span class="token selector">.p3</span> <span class="token punctuation">{</span>
  ...
  <span class="token property">border-style</span><span class="token punctuation">:</span> dashed solid dashed dashed<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_7-2-for" tabindex="-1"><a class="header-anchor" href="#_7-2-for" aria-hidden="true">#</a> 7.2 <code>@for</code></h2><blockquote><p><code>@for</code>指令可以在限制的范围内重复输出格式，每次按要求(变星的值)对输出结果做出变动。这个指令包含两种格式： <code>@for $var from &lt;start&gt; through &lt;end&gt;</code>，或者<code>@for $var from &lt;start&gt; to &lt;end&gt;</code></p></blockquote><p>区别在于<code>through</code>与<code>to</code>的含义: 当使用<code>through</code>时，条件范围包含<code>&lt;start&gt;</code> 与<code>&lt;end&gt;</code>的值。 而使用<code>to</code>时条件范围只包含<code>&lt;start&gt;</code> 的值不包含<code>&lt;end&gt;</code> 的值。 另外，$var可以是任何变量，比如<code>$i</code>; <code>&lt;start&gt;</code>和<code>&lt;end&gt;</code>必须是整数值。</p><p>scss文件：</p><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token keyword">@for</span> <span class="token variable">$i</span> <span class="token keyword">from</span> <span class="token selector">1 to 4 </span><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_7-4-where" tabindex="-1"><a class="header-anchor" href="#_7-4-where" aria-hidden="true">#</a> 7.4 <code>@where</code></h2><p>@while指令重复输出格式直到表达式返回结果为false.这样可以实现比@for更复杂的循环。 用sass实现bootstrap中css的这么一段代码 https://stackpath.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.css</p><p>scss文件：</p><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token property"><span class="token variable">$column</span></span><span class="token punctuation">:</span>12<span class="token punctuation">;</span>
...
<span class="token selector">.top</span> <span class="token punctuation">{</span>
  ...
  <span class="token property">width</span><span class="token punctuation">:</span> 30px<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>混入<code>mixin</code>和函数<code>function</code>的区别</strong></p><ul><li><p>混入<code>mixin</code>主要是通过传递参数的方式输出多样化的样式，为了可以现实代码复用。</p></li><li><p>函数的功能主要是通过传递参数后，经过函数内部的计算，最后<code>@return</code>输出一个值。</p></li></ul><h2 id="_7-6-if三元条件函数" tabindex="-1"><a class="header-anchor" href="#_7-6-if三元条件函数" aria-hidden="true">#</a> 7.6 <code>if</code>三元条件函数</h2><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token function">if</span><span class="token punctuation">(</span><span class="token variable">$condition</span><span class="token punctuation">,</span><span class="token variable">$if-true</span><span class="token punctuation">,</span><span class="token variable">$if-false</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_7-9-at-root" tabindex="-1"><a class="header-anchor" href="#_7-9-at-root" aria-hidden="true">#</a> 7.9 <code>@at-root</code></h2><p><code>@at-root</code>可以使被嵌套的选择器或属性跳出嵌套</p><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code>@<span class="token selector">at-root &lt;selector&gt;</span><span class="token punctuation">{</span>
    ...
<span class="token punctuation">}</span>
