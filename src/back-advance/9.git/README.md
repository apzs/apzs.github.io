...
>
><img src="https://gitlab.com/apzs/image/-/raw/master/image/image-20210813153403664.png" alt="image-20210813153403664" style="zoom:67%;" /> 
>
>Ⅱ- 此时可以看到,错误的 [ commit ] 已经提交了 (当然,适用场景不只是commit ,也可错误代码之类的)
>
>![image-20210813155746112](https://gitlab.com/apzs/image/-/raw/master/image/image-20210813155746112.png) 
...
>
>![image-20210813154309057](https://gitlab.com/apzs/image/-/raw/master/image/image-20210813154309057.png) 

###### ②  git  reset --soft HEAD~

>运行此代码后,我们的 [ HEAD ] 指向了上一个 [ commits ]
>
>![image-20210813154448889](https://gitlab.com/apzs/image/-/raw/master/image/image-20210813154448889.png) 
...
>
>   ![image-20210813154839981](https://gitlab.com/apzs/image/-/raw/master/image/image-20210813154839981.png) 

###### ④ 重新撰写 [ commit ]信息

>![image-20210813154928064](https://gitlab.com/apzs/image/-/raw/master/image/image-20210813154928064.png) 
...
>>`git push -f`
>
>![image-20210813155049169](https://gitlab.com/apzs/image/-/raw/master/image/image-20210813155049169.png) 
...
>
>![image-20210813155614570](https://gitlab.com/apzs/image/-/raw/master/image/image-20210813155614570.png) 
>
>* 但是你查看提交记录,会发现之前错误的commit已经被覆盖
>
><img src="https://gitlab.com/apzs/image/-/raw/master/image/image-20210813155339300.png" alt="image-20210813155339300" style="zoom:80%;" />
...
>
> ![image-20210621172453710](https://gitlab.com/apzs/image/-/raw/master/image/image-20210621172453710.png)
>
...
>
> ![image-20210621171934972](https://gitlab.com/apzs/image/-/raw/master/image/image-20210621171934972.png)
>
...
>4. 截图示例
>
>   ![image-20210705115521085](https://gitlab.com/apzs/image/-/raw/master/image/image-20210705115521085.png)
...
>2. 图示
>
>   ![image-20210508171542001](https://gitlab.com/apzs/image/-/raw/master/image/列出仓库中最大的几个对象及其文件名.png)
...
>2. 图示
>
>   ![image-20210508171916951](https://gitlab.com/apzs/image/-/raw/master/image/image-20210508171916951.png)
...
>2. 图示
>
>   ![](https://gitlab.com/apzs/image/-/raw/master/image/删除截图.png)
>
>3. 补充注意点:
>
...
>2. 图示
>
>  ![image-20210510183253770](https://gitlab.com/apzs/image/-/raw/master/image/image-20210510183253770.png)
>
...
>2. 图示
>
>   ![](https://gitlab.com/apzs/image/-/raw/master/image/强制提交.jpg)
...
>
>
>![image-20210510180757993](https://gitlab.com/apzs/image/-/raw/master/image/image-20210510180757993.png)
...
>1. 删除前截图
>
>  <img src="https://gitlab.com/apzs/image/-/raw/master/image/删除大文件前大小.png" style="zoom:67%;" />
>
>2. 删除后截图
>
>  <img src="https://gitlab.com/apzs/image/-/raw/master/image/删除大文件后大小.png" style="zoom:67%;" />
>
>3. 删除多个文件后
>
>   <img src="https://gitlab.com/apzs/image/-/raw/master/image/image-20210508182039450.png" alt="image-20210508182039450" style="zoom:67%;" />
...
>
>   ![image-20210510171915185](https://gitlab.com/apzs/image/-/raw/master/image/image-20210510171915185.png)
>
>3. 解决思路
>
...
>4. 解决结果截图
>
>   <img src="https://gitlab.com/apzs/image/-/raw/master/image/image-20210510172159472.png" alt="image-20210510172159472" style="zoom:67%;" />

### 7、远程仓库过大导致无法push

>问题出现场景:在前两天本人发现笔记仓库过大 已经达到600M的时候,本人花了一些时间将无用的大文件删除(详见`问题5`),并且减小到了100M+,然后推送上了gitee上,但是今天push的时候突然报错仓库过大无法推送
>
>1. 问题报错截图![image-20210510180415796](https://gitlab.com/apzs/image/-/raw/master/image/image-20210510180415796.png)
>
...
>
>       <img src="https://gitlab.com/apzs/image/-/raw/master/image/image-20210510180539437.png" alt="image-20210510180539437" style="zoom:50%;" /><img src="https://gitlab.com/apzs/image/-/raw/master/image/image-20210510181407805.png" alt="image-20210510181407805" style="zoom:67%;" />
>
>3. 问题解决:
>
>    ![image-20210510180757993](https://gitlab.com/apzs/image/-/raw/master/image/image-20210510180757993.png)
>
>    GC后内存![image-20210510181329197](https://gitlab.com/apzs/image/-/raw/master/image/image-20210510181329197.png)
>
>   4. GC详解
>
...
>
>   **![image-20210701180547401](https://gitlab.com/apzs/image/-/raw/master/image/image-20210701180547401.png) 
>
>2. 解决方案2:命令行
>
>   ```sh
...
>3. 截图示例
>
>   > ![Git 切换远程仓库地址](https://gitlab.com/apzs/image/-/raw/master/image/Git切换远程仓库地址.png)
