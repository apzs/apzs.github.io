...
> 现已集成到webpack中了，可以直接在`main.js`中使用`/* webpackPrefetch: true */`
>
> ```js
> console.log("hello main");
> 
> document.getElementById("btn").onclick = function () {
>   import(/* webpackChunkName: "math" */
>   /* webpackPrefetch: true */ "./math.js").then(({ sum }) => {
>     alert(sum(1, 2, 3, 4, 5));
>   });
> };
> ```
>
> ![image-20240104102315163](https://gitlab.com/apzs/image/-/raw/master/image/image-20240104102315163.png)
>
> ```
> <link rel="prefetch" as="script" href="http://127.0.0.1:5500/dist/js/../js/math.js">
> ```
>
> ![image-20240104102320323](https://gitlab.com/apzs/image/-/raw/master/image/image-20240104102320323.png)
>
> Preload稍微坑一些，不能直接使用`/* webpackPreload: true */`，我们可以在`main.js`中引入中间文件`temp.js`
>
> ```js
> console.log("hello main");
> 
> document.getElementById("btn").onclick = function () {
>     import(/* webpackChunkName: "temp" */ './temp.js')
> };
> ```
>
> 然后在`temp.js`文件中使用`/* webpackPreload: true */`
>
> ```js
> import(/* webpackChunkName: "math" */
> /* webpackPreload: true */ "./math.js").then(({ sum }) => {
>   alert(sum(1, 2, 3, 4, 5));
> });
> ```
>
> 这样，当我们点击`计算`后，才加载出我们想要的`math.js`
>
> <img src="https://gitlab.com/apzs/image/-/raw/master/image/image-20240104110048684.png" alt="image-20240104110048684" style="zoom:50%;" />
>
> <img src="https://gitlab.com/apzs/image/-/raw/master/image/image-20240104110100125.png" alt="image-20240104110100125" style="zoom: 50%;" />
