...
![loader执行流程](https://gitlab.com/apzs/image/-/raw/master/image/loader1.png)

在这个过程中如果任何 pitch 有返回值，则 loader 链被阻断。webpack 会跳过后面所有的的 pitch 和 loader，直接进入上一个 loader 。

![loader执行流程](https://gitlab.com/apzs/image/-/raw/master/image/loader2.png)
...
![Webpack 插件生命周期](https://gitlab.com/apzs/image/-/raw/master/image/plugin.jpg)
...
- `webpack.config.js`引入`TestPlugin`
...
![调试控制台](https://gitlab.com/apzs/image/-/raw/master/image/debug.png)
