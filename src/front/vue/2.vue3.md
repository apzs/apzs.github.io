...
<img src="./image/1683167182037-71c78210-8217-4e7d-9a83-e463035efbbe.png" alt="webpack构建" title="webpack构建" style="zoom:20%;box-shadow:0 0 10px black" />	<img src="./image/1683167204081-582dc237-72bc-499e-9589-2cdfd452e62f.png" alt="vite构建" title="vite构建" style="zoom: 20%;box-shadow:0 0 10px black" />
...
<img src="./image/volar.png" alt="Snipaste_2023-10-08_20-46-34" style="zoom:50%;" /> 

<img src="./image/image-20231218085906380.png" alt="image-20231218085906380" style="zoom:42%;" /> 
...
<img src="./image/1696662197101-55d2b251-f6e5-47f4-b3f1-d8531bbf9279.gif" alt="1.gif" style="zoom:70%;border-radius:20px" /><img src="./image/1696662200734-1bad8249-d7a2-423e-a3c3-ab4c110628be.gif" alt="2.gif" style="zoom:70%;border-radius:20px" />

#### Composition API 的优势

可以用函数的方式，更加优雅的组织代码，让相关功能的代码更加有序的组织在一起。

<img src="./image/1696662249851-db6403a1-acb5-481a-88e0-e1e34d2ef53a.gif" alt="3.gif" style="height:300px;border-radius:10px"  /><img src="./image/1696662256560-7239b9f9-a770-43c1-9386-6cc12ef1e9c0.gif" alt="4.gif" style="height:300px;border-radius:10px"  />
...
>
>    <img src="./image/自动补充value.png" alt="自动补充value" style="zoom:50%;border-radius:20px" /> 
>
...
![GIF 2024-2-14 21-08-31](./image/GIF%202024-2-14%2021-08-31.gif)
...
<img src="./image/computed.gif" style="zoom:20%;" />  
...
>
> <img src="./image/GIF%202024-2-14%2016-29-34.gif" alt="GIF 2024-2-14 16-29-34" style="zoom:50%;" />
...
![image-20240214191554560](./image/image-20240214191554560.png)
...
![image-20240214193904091](./image/image-20240214193904091.png)
...
> ```
>
> ![image-20240219213329582](./image/image-20240219213329582.png)
...
![image-20240214200341270](./image/image-20240214200341270.png)
...
<img src="./image/image-20231018144351536.png" alt="image-20231018144351536" style="zoom:20%;border-radius:40px" /> 
...
![image-20240219211540954](./image/image-20240219211540954.png)
...
![image-20240219211638558](./image/image-20240219211638558.png)
...
![GIF 2024-2-21 10-26-13](./image/GIF%202024-2-21%2010-26-13.gif)
...
![GIF 2024-2-21 10-25-12](./image/GIF%202024-2-21%2010-25-12.gif)
...
![GIF 2024-2-21 10-49-40](./image/GIF%202024-2-21%2010-49-40.gif)
...
![GIF 2024-2-21 10-53-27](./image/GIF%202024-2-21%2010-53-27.gif)
...
![image-20240221110628384](./image/image-20240221110628384.png)
...
![image-20240221135101929](./image/image-20240221135101929.png)
...
<img src="./image/pinia_example.gif" alt="pinia_example" style="zoom:30%;border:3px solid" /> 
...
![image-20230614213822296](./image/image-20230614213822296.png)
...
![image-20230614223735480](./image/image-20230614223735480.png)
...
![image-20230618181037465](./image/image-20230618181037465.png)
...
![image-20230618180756271](./image/image-20230618180756271.png)
...
![image-20230618150520708](./image/image-20230618150520708.png)

### ⑦ `provide` 与 `inject`（隔代组件通讯）

> 使用`provide` 和`inject`允许隔代获取数据，也可以隔代修改数据

![img](./image/f766fada7fdb47b59a1191e3402e9bb2tplv-k3u1fbpfcp-zoom-in-crop-mark4536000-17085826446331.webp)
...
<img src="./image/image-20230618182639773.png" alt="image-20230618182639773" style="zoom:50%;" />

点击败家之后

<img src="./image/image-20230618182650313.png" alt="image-20230618182650313" style="zoom:50%;" />
...
![image-20230618153548174](./image/image-20230618153548174.png)
...
![image-20230618153822127](./image/image-20230618153822127.png)
...
![image-20230702171955667](./image/image-20230702171955667.png)
