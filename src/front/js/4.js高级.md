...
没添加 `Function` 的原型链： ![原型链](image/bgAurV.png)

添加 `Function` 后的原型链： ![原型2](image/bg8UEj.png)
...
![prototype1](image/prototype1.h8mujzc530g.png)
...
![output1](image/output1.4ezc1vfpb5o0.png)
...
函数也属于对象，同样有原型对象，原型链： ![function1](image/function1.50ysdtr2sfk0.png)
