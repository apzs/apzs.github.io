...
- 现实世界的事物都有属性和行为,可在程序中抽离为类来描述现实世界的事物属性和行为。
  ![img](./image/e1cd967b241139fb3016768418eb89e9.png)
- 使用**类**充当程序内现实事物的“设计图纸”，基于图纸(类)生产实体（对象），由对象做具体的工作，称之为：**面向对象编程**
- 在现实世界中，生产事物：先设计图纸，完成功能属性分析，再批量制造
  ![img](./image/ff7feca7800b0e823b76cef27da01b42.png)
- 在程序中，通过类作为事物的设计图纸，记录事物的属性和行为
  ![img](./image/6d185193b75bb92f6aa70bbeb7b10d0b.png)
- 基于类(设计图纸)构建(生产)闹钟对象
  ![img](./image/f695cba9bcf0f4f8478c48fd69a4b349.png)
...
![img](./image/ccd43c6dda07c81b443e46b6e0a8ed21.png)
...
- 概览:
  ![img](./image/e3600f037eeea63d5555ecb539b249e8.png)
...
- 使用了构造方法，创建对象时必须传参否则会报错
  ![img](./image/62fda5cc61db9cc89342cb8ddf9ead2a.png)
...
![img](./image/fd8620c1756e992960b65282f817c856.png)
...
> 将现实世界事物的属性和行为+在类中描述为成员变量和成员方法,完成程序对现实世界事物的描述

![img](./image/d49a8ff5c489b0989dae1e25622d4090.png)

- 现实世界中的事物，有属性和行为。但是不代表这些属性和行为都是开放给用户使用的
  ![img](./image/dfba9b4b5319cdc7975943410a8a1878.png)

##### (1.1) 私有成员

> 在类中提供仅供内部使用的属性和方法，无法被对象调用

![img](./image/9eb922235b84e4ef1953a2126491751e.png)
...
![img](./image/4b5fd02a65b1ad1c4f470791ebb0d547.png)
...
![img](./image/90d55d003801b91b2753544fb4579818.png)

- 多态常作用在继承关系上，函数(方法)形参声明接收父类对象，实际传入父类的子类对象进行工作，即
  - 以父类做定义声明
  - 以子类做实际工作
  - 用以获得同一行为, 不同状态
    ![img](./image/f1e34714421640e3c75337287eb82cf4.png)

##### (3.1) 抽象类(接口)

> 抽象类就好比定义一个标准，包含了一些抽象的方法，要求子类必须实现

![img](./image/f0aa62f8b93511815e9390aa8f015efd.png)
...
- `pass`是占位语句，用来保证函数（方法）或类定义的完整性，表示无内容，空的意思
  ![img](./image/81f0dfb915be516f854988b5d30cdf2e.png)
...
![img](./image/cfc2851172a9d2e631da6d03f583b400.png)
