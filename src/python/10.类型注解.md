...
> 文末附带全文概览[思维导图](https://so.csdn.net/so/search?q=思维导图&spm=1001.2101.3001.7020)
...
- 帮助第三方IDE工具（如PyCharm）对代码进行类型推断，协助做代码提示
  ![img](./image/1daa1d40b06bfa3f2dfaabab402b0bdc.png)
  - 显示声明时，pycharm确定这个对象是list类型，使用时能有对应提示
    ![img](./image/0bdcd9e95dcf7f5312e5a4a05995fcc4.png)
  - 没有声明具体类型时，使用不会有任何相关提示
    ![img](./image/2659f14ef1c8f65972923f613ba25bf6.png)
...
![img](./image/2f52032155a37a965097bfa09811b609.png)
...
![img](./image/a797fd7b6c575fe32b94e492a3a06223.png)
...
- 使用示例：
  ![img](./image/97e2488b582bc96037d3581800216107.png)
...
![img](./image/8476c1405f62fa7c6198827fba5fbc77.png)
