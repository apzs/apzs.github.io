...
![](./image/format,png-16709865349641.png)
...
![](./image/format,png-16709865349642.png)
...
![](./image/format,png-16709865349656.png)
...
![](./image/2020061321233250.png)

**保存镜像任务执行完毕，我们来看下指定位置下是否有该tar？**

![](./image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2xlaWxlaTEzNjY2MTU=,size_16,color_FFFFFF,t_70.png)
...
![](./image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2xlaWxlaTEzNjY2MTU=,size_16,color_FFFFFF,t_70-16709865349657.png)

**加载文件 恢复为镜像**

![](./image/20200613213225208.png)

**查看镜像 测试镜像功能是否正常**

我们来把解压的镜像 run一下。

![](./image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2xlaWxlaTEzNjY2MTU=,size_16,color_FFFFFF,t_70-16709865349668.png)
...
![](./image/3a312631bd04dbc67a1a1d41560858a8.png)
...
![](./image/format,png-16709865349669.png)
...
![](./image/format,png-167098653496610.png)
...
![](./image/d3ffd76e30f032506708efe7608ade2d.png)
...
![](./image/format,png-167098653496713.png)

然后**删除容器** -----不经意间 咱发现已经运行过这么多容器了 咱进行清理一下

![](./image/format,png-167098653496714.png)
...
![](./image/format,png-167098653496715.png)
...
![](./image/format,png-167098653496716.png)

在运行后 发现服务器的 8888 端口显示已被docker-proxy 所占用了 那么此时咱再用工具进行连接测试呢？

![](./image/format,png-167098653496717.png)
...
![](./image/format,png-167098653496718.png)
...
![](./image/format,png-167098653496719.png)
...
![](./image/cba7a339ffed1980db842f87276661f3.png)
...
![](./image/format,png-167098653496720.png)
![](./image/format,png-167098653496721.png)

咱们的webapps 下一个文件都没有 ，访问肯定404罗

不断查看 发现咱 webapps.dist 下是有文件的 我们把它拷贝的webapps 下 然后打包成一个新的镜像 后 访问查看是否进入到首页 不进入404页面

![](./image/format,png-167098653496822.png)
...
![](./image/format,png-167098653496823.png)  
为了区分 咱停止并删除之前tomcat 的容器  
![](./image/format,png-167098653496824.png)
...
![](./image/format,png-167098653496825.png)

![](./image/format,png-167098653496826.png)
...
![](./image/fbd50d429b6161ccf7d73687bc63ef06.png)
...
![](./image/9e6acfeb2e77bb2d25e63a7c1bff7709.png)
...
![](./image/a33dbf0f51a3f2ac179d102466e6517f.png)
...
![](./image/f19ff29dbc1a1cd739f26dd9e69d2f96.png)
...
![](./image/5b95b414c6fa466b71ea2c507019df8d.png)
...
![image-20221215161858131](./image/image-20221215161858131.png)
