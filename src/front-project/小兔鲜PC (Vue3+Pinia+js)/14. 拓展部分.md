...
![image.png](https://gitlab.com/apzs/image/-/raw/master/image/1677821818707-dc5529c0-fa8f-442a-af7a-43ad258106f2.png)
```vue
<script setup>
...
## 3. 规格禁用功能实现
### 整体思路分析
![1.png](https://gitlab.com/apzs/image/-/raw/master/image/1677747580985-234fe1bd-483d-49eb-a9cd-42e3a009a375.png)
### 生成路径字典
幂集算法
```javascript
