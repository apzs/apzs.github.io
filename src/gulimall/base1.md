...
![image-20221214095755009](./image/image-20221214095755009.png)
...
![image-20221214095911038](./image/image-20221214095911038.png)

在`/mydata/mysql/conf/mysql.conf.d/`里添加`my.cnf`配置文件，[点击查看文件内容](code\my.cnf)

![image-20221214100016478](./image/image-20221214100016478.png)
