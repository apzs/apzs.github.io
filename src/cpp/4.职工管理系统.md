...
![1546511409198](./image/1546511409198.png)
...
![1544151201465](./image/15441512014652.png)

填写项目名称以及项目路径，点击确定

![1546349209805](./image/1546349209805.png)

### 2.2 添加文件

右键源文件，进行添加文件操作

![1546349360960](./image/1546349360960.png)

![1546349421496](./image/1546349421496.png)

![1546349488752](./image/1546349488752.png)
...
![1546349904944](./image/1546349904944.png)
...
![1546351543942](./image/1546351543942.png)
...
![1546352771191](./image/1546352771191.png)
...
![1546353199424](./image/1546353199424.png)

运行测试效果如图：

![1546353155490](./image/1546353155490.png)
...
![1546398236081](./image/1546398236081.png)
...
![1546399491099](./image/1546399491099.png)
...
![1546401705277](./image/1546401705277.png)

效果如图：

![1546401763461](./image/1546401763461.png)
...
![1546432469465](./image/1546432469465.png)
...
![1546432343078](./image/1546432343078.png)
...
![1546435197575](./image/1546435197575.png)
...
![1546656256176](./image/1546656256176.png)
...
![1546436429055](./image/1546436429055.png)

![1546436385793](./image/1546436385793.png)
...
![1546436938152](./image/1546436938152.png)
...
![1546497336465](./image/1546497336465.png)
...
![1546497082135](./image/1546497082135.png)

测试2 - 文件存在且有记录情况

![1546496947671](./image/1546496947671.png)
...
![1546502698622](./image/1546502698622.png)

测试1 - 删除不存在职工情况

![1546500324196](./image/1546500324196.png)

测试2 - 删除存在的职工情况

删除成功提示图：

![1546500350526](./image/1546500350526.png)

再次显示所有职工信息，确保已经删除

![1546500361889](./image/1546500361889.png)

查看文件中信息，再次核实员工已被完全删除

![1546500383570](./image/1546500383570.png)
...
![1546502651922](./image/1546502651922.png)

测试1 - 修改不存在职工情况

![1546502759643](./image/1546502759643.png)

测试2 - 修改存在职工情况，例如将职工 "李四" 改为 "赵四"

![1546502830350](./image/1546502830350.png)

修改后再次查看所有职工信息，并确认修改成功

![1546502865443](./image/1546502865443.png)

再次确认文件中信息也同步更新

![1546502898653](./image/1546502898653.png)
...
![1546504714318](./image/1546504714318.png)

测试1 - 按照职工编号查找 - 查找不存在职工

![1546504767229](./image/1546504767229.png)

测试2 - 按照职工编号查找 -  查找存在职工

![1546505046521](./image/1546505046521.png)

测试3 - 按照职工姓名查找 - 查找不存在职工

![1546505115610](./image/1546505115610.png)

测试4 - 按照职工姓名查找 - 查找存在职工（如果出现重名，也一并显示，在文件中可以添加重名职工）

例如 添加两个王五的职工，然后按照姓名查找王五

![1546507850441](./image/1546507850441.png)

![1546507760284](./image/1546507760284.png)
...
![1546510145181](./image/1546510145181.png)

测试：

首先我们添加一些职工，序号是无序的，例如：

![1546658169987](./image/1546658169987.png)

测试 - 升序排序

![1546658190479](./image/1546658190479.png)

文件同步更新

![1546658273581](./image/1546658273581.png)

测试 - 降序排序

![1546658288936](./image/1546658288936.png)

文件同步更新

![1546658313704](./image/1546658313704.png)
...
![1546511085541](./image/1546511085541.png)

测试：确认清空文件

![1546510976745](./image/1546510976745.png)

再次查看文件中数据，记录已为空

![1546510994196](./image/1546510994196.png)

打开文件，里面数据已确保清空，该功能需要慎用！

![1546511018517](./image/1546511018517.png)
