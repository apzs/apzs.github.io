...
![1548154762048](./image/1548154762048.png)
...
![1548155966702](./image/1548155966702.png)
...
![1548121881969](./image/1548121881969.png)

* 填写项目名称以及选取项目路径，点击确定生成项目

![1548122271773](./image/1548122271773.png)

### 2.2 添加文件

* 右键源文件，进行添加文件操作

![1548122420253](./image/1548122420253.png)

* 填写文件名称，点击添加

![1548122510869](./image/1548122510869.png)

* 生成文件成功，效果如下图

![1548122619712](./image/1548122619712.png)
...
![1548123402593](./image/1548123402593.png)
...
![1548123942072](./image/1548123942072.png)
...
![1548124599641](./image/1548124599641.png)
...
![1548124853576](./image/1548124853576.png)

运行测试效果如图：

![1548124888578](./image/1548124888578.png)
...
![1548141605742](./image/1548141605742.png)

* 测试效果如图：

![1548141560164](./image/1548141560164.png)
...
![1548143871202](./image/1548143871202.png)

* 在main函数中，分支1选项中，调用开始比赛的接口

![1548143543475](./image/1548143543475.png)



* 测试

![1548143610682](./image/1548143610682.png)
...
![1548144491984](./image/1548144491984.png)



* 再次运行代码，测试比赛

![1548144765146](./image/1548144765146.png)
...
![1548146903960](./image/1548146903960.png)

* 运行代码，测试效果

![1548146961550](./image/1548146961550.png)
...
![1548148593215](./image/1548148593215.png)

测试，将整个比赛流程都跑通

![1548148536395](./image/1548148536395.png)
...
![1548149937860](./image/1548149937860.png)

* 测试，整个比赛完毕后记录保存情况

![1548149912863](./image/1548149912863.png)

利用记事本打开文件 speech.csv，里面保存了前三名选手的编号以及得分

![1548150047975](./image/1548150047975.png)
...
![1548151977242](./image/1548151977242.png)
...
![1548152359604](./image/1548152359604.png)

显示效果如图：（本次测试添加了4条记录）

![1548152394715](./image/1548152394715.png)
...
![1548152803116](./image/1548152803116.png)

2. 若记录为空或不存在，比完赛后依然提示记录为空

解决方式：saveRecord中更新文件为空的标志

![1548153005042](./image/1548153005042.png)

3. 比完赛后查不到本届比赛的记录，没有实时更新

解决方式：比赛完毕后，所有数据重置

![1548153319587](./image/1548153319587.png)

4. 在初始化时，没有初始化记录容器

解决方式：initSpeech中添加 初始化记录容器

![1548154340974](./image/1548154340974.png)
...
![1548153571603](./image/1548153571603.png)
...
![1548154674242](./image/1548154674242.png)

运行程序，测试清空记录：

![1548154004738](./image/1548154004738.png)

speech.csv中记录也为空

![1548154508831](./image/1548154508831.png)
