...
![](https://gitlab.com/apzs/image/-/raw/master/image/数据结构比喻.png)
...
* 栈的入口、出口的都是栈的顶端位置。
  ...
  ![](https://gitlab.com/apzs/image/-/raw/master/image/堆栈.png)
...
![](https://gitlab.com/apzs/image/-/raw/master/image/队列图.bmp)
...
*  查找元素快：通过索引，可以快速访问指定位置的元素
   ...
   ![](https://gitlab.com/apzs/image/-/raw/master/image/数组查询快.png)

*  增删元素慢
  * **指定索引位置增加元素**：需要创建一个新数组，将指定新元素存储在指定索引位置，再把原数组元素根据索引，复制到新数组对应索引的位置。如下图![](https://gitlab.com/apzs/image/-/raw/master/image/数组添加.png)
  * **指定索引位置删除元素：**需要创建一个新数组，把原数组元素根据索引，复制到新数组对应索引的位置，原数组中指定索引位置元素不复制到新数组中。如下图![](https://gitlab.com/apzs/image/-/raw/master/image/数组删除.png)
...
* **链表**:**linked list**,由一系列结点node（链表中每一个元素称为结点）组成，结点可以在运行时i动态生成。每个结点包括两个部分：一个是存储数据元素的数据域，另一个是存储下一个结点地址的指针域。我们常说的链表结构有单向链表与双向链表，那么这里给大家介绍的是**单向链表**。
  ...
  ![](https://gitlab.com/apzs/image/-/raw/master/image/单链表结构特点.png)

简单的说，采用该结构的集合，对元素的存取有如下的特点：

* 多个结点之间，通过地址进行连接。例如，多个人手拉手，每个人使用自己的右手拉住下个人的左手，依次类推，这样多个人就连在一起了。

  ![](https://gitlab.com/apzs/image/-/raw/master/image/单链表结构.png)
...
* 增删元素快：
  ...
  *  增加元素：只需要修改连接下个元素的地址即可。
    ...
    ![](https://gitlab.com/apzs/image/-/raw/master/image/增加结点.png)

  *  删除元素：只需要修改连接下个元素的地址即可。

    ![](https://gitlab.com/apzs/image/-/raw/master/image/删除结点.bmp)
...
![](https://gitlab.com/apzs/image/-/raw/master/image/二叉树.bmp)
...
![](https://gitlab.com/apzs/image/-/raw/master/image/双向链表.png)
...
简单的来说，哈希表是由数组+链表+红黑树（JDK1.8增加了红黑树部分）实现的，如下图所示。![](https://gitlab.com/apzs/image/-/raw/master/image/哈希表.png)

看到这张图就有人要问了，这个是怎么存储的呢？

为了方便大家的理解我们结合一个存储流程图来说明一下：

![](https://gitlab.com/apzs/image/-/raw/master/image/哈希流程图.png)
