...
![结构图](./image/MySQL%E4%BD%93%E7%B3%BB%E7%BB%93%E6%9E%84_20220315034329549927.png)  
![层级描述](./image/MySQL%E4%BD%93%E7%B3%BB%E7%BB%93%E6%9E%84%E5%B1%82%E7%BA%A7%E5%90%AB%E4%B9%89_20220315034359342837.png)  
...
InnoDB 逻辑存储结构：  
![InnoDB逻辑存储结构](./image/%E9%80%BB%E8%BE%91%E5%AD%98%E5%82%A8%E7%BB%93%E6%9E%84_20220316030616590001.png)  
...
![二叉树](./image/%E4%BA%8C%E5%8F%89%E6%A0%91_20220316153214227108.png)

二叉树形成链表的缺点可以用红黑树来解决：
![红黑树](./image/%E7%BA%A2%E9%BB%91%E6%A0%91_20220316163142686602.png)
红黑树也存在大数据量情况下，层级较深，检索速度慢的问题。

为了解决上述问题，可以使用 B-Tree 结构。
B-Tree (多路平衡查找树) 以一棵最大度数（max-degree，指一个节点的子节点个数）为5（5阶）的 b-tree 为例（每个节点最多存储4个key，5个指针）

![B-Tree结构](./image/B-Tree%E7%BB%93%E6%9E%84_20220316163813441163.png)
...
![B+Tree结构图](./image/B+Tree%E7%BB%93%E6%9E%84%E5%9B%BE_20220316170700591277.png)
...
![MySQL B+Tree 结构图](./image/%E7%BB%93%E6%9E%84%E5%9B%BE_20220316171730865611.png "MySQL B+Tree 结构图")
...
![Hash索引原理图](./image/Hash%E7%B4%A2%E5%BC%95%E5%8E%9F%E7%90%86%E5%9B%BE_20220317143226150679.png "Hash索引原理图")
...
![大致原理](./image/%E5%8E%9F%E7%90%86%E5%9B%BE_20220318194454880073.png "大致原理")
![演示图](./image/%E6%BC%94%E7%A4%BA%E5%9B%BE_20220319215403721066.png "演示图")
...
![images](./image/artic.png )

Buffer Pool：缓冲池是主内存中的一个区域，里面可以缓存磁盘上经常操作的真实数据，在执行增删改查操作时，先操作缓冲池中的数据（若缓冲池没有数据，则从磁盘加载并缓存），然后再以一定频率刷新到磁盘，从而减少磁盘I0，加快处理速度。

![images](./image/artic2.png )
![images](./image/artic3.png )
![images](./image/artic4.png )
![images](./image/artic5.png )


磁盘架构：
![images](./image/artic6.png )
![images](./image/artic7.png )
![images](./image/artic8.png )
...
![images](./image/MVCCList.png )

如何确定返回哪一个版本 这是由read view决定返回 undo log 中的哪一个版本。

![images](./image/readview0.png )
